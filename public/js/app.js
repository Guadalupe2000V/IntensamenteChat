...
// El usuario, contiene el ID de la emocion seleccionado
var usuario;
...
//Detectar la conexion de internet
function isOnline(){
    if(navigator.onLine){
...
function enviarNotificaciones(){
    ...
    const n = new Notification('Intensamente', Notif);
    n.onclick=()=>{
        console.log('Click');
    };
}
...
function cancelarSuscripcion(){
    swReg.pushManager.getSubscription().then(subs=>{
        subs.unsuscribe().then(()=>verificaSuscripcion(false));
    });
}
